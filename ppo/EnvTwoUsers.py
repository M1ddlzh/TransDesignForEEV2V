"""
This is my own Environment for tow-users vehicles network.
gym: 0.9.2
"""
...
class EnvTwoUsers():
    ...
    def step(self, info):
        ...
        p1 = p1 * (self.power_max / 2) + (self.power_max / 2) + 1e-15       # dBm
    ...
    def reset(self):
        ...
        # sum_r_1, sum_p_1, sum_r_2, sum_p_2 = 1e-15, 1e-15, 1e-15, 1e-15
