...
def get_args():
    ...
    parser.add_argument('--task', type=str, default='twousers')
    ...
    parser.add_argument('--unit_num', type=int, default=32)
...
def training_ddpg(args=get_args()):
    ...
    train_envs = VectorEnv(
        [lambda: EnvTwoUsers(args.step_per_epoch) for _ in range(args.training_num)])
    test_envs = VectorEnv(
    ...
    net = Net(args.layer_num, args.state_shape,
        ...
        hidden_layer_size=args.unit_num)
    critic = Critic(net, args.device, hidden_layer_size=args.unit_num).to(args.device)
...
def testing_ddpg(args=get_args()):
    ...
    print('large than Qmax: users1: {}, users2: {}.\n'
